#!/usr/bin/env python
# Convert FaultGeom file, output of IDSMODEL/GINVPY to input file of the EDCMP software
...
def main():
    parser  = argparse.ArgumentParser(description="Convert FaultGeom file to EDCMP input file.")
